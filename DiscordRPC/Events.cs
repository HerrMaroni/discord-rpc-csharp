...
public delegate void RpcMessageEvent(object sender, Message.Message msg);
...
/// <param name="sender">The Discord client handler that sent this event</param>
/// <param name="args">The arguments supplied with the event</param>
public delegate void AuthorizeEvent(object sender, AuthorizeMessage args);
...
/// <param name="sender">The Discord client handler that sent this event</param>
/// <param name="args">The arguments supplied with the event</param>
public delegate void AuthenticateEvent(object sender, AuthenticateMessage args);

/// <summary>
///     Called when the Discord Client has sent an SetVoiceSettings Response.
/// </summary>
/// <param name="sender">The Discord client handler that sent this event</param>
/// <param name="args">The arguments supplied with the event</param>
public delegate void VoiceSettingsEvent(object sender, VoiceSettingsMessage args);